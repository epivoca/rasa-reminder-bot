...
class ActionRemindBuyFood(Action):
    """Reminds the user to buy food."""

    def name(self) -> Text:
        return "action_remind_buy_food"
    ...
    async def run(
        ...
        dispatcher.utter_message("Remember to buy some food!")

        return []


class ActionRemindWashWindows(Action):
    """Reminds the user to wash windows."""

    def name(self) -> Text:
        return "action_remind_wash_windows"
    ...
    async def run(
        ...
        dispatcher.utter_message("Don't forget to wash the windows!")

        return []


class ActionRemindWalkDog(Action):
    """Reminds the user to walk the dog."""

    def name(self) -> Text:
        return "action_remind_walk_dog"
    ...
    async def run(
        ...
        dispatcher.utter_message("Take your dog for a walk today!")
